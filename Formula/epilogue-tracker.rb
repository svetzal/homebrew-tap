...
class EpilogueTracker < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "19c3721788def18ac9d0908a24907cd77c7e385799c683fdae78fd8f408cdf14"
    ...
    on_intel do
      ...
      sha256 "ea5f50f82a70170a8da6c3977564b9bce080efe1576089492dc93a9dd154cd17"
  ...
  on_linux do
    on_intel do
      ...
      sha256 "678ff9e33053d19a8383bedead74396c2633faea4146d3f720350c8bab87ab8c"
